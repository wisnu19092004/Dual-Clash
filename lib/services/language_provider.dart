...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'official_edition': {
      'id': 'ARENA STRATEGI PAPAN DUNIA',
      'en': 'WORLD BOARD STRATEGY ARENA',
      'ja': '世界最高峰の盤上戦略アリーナ',
      'ms': 'ARENA STRATEGI PAPAN DUNIA',
    },
    'hero_desc': {
      'id':
          'Asah taktik & strategi Anda dalam Catur Barat dan Shogi Tradisional Jepang.',
      'en': 'Master your tactics and intellect in Classic Chess and Japanese Shogi.',
      'ja': '西洋チェスと伝統日本将棋で、至高の戦術と知性を磨き上げろ。',
      'ms': 'Asah taktik dan strategi anda dalam Catur Klasik dan Syogi Jepun.',
    },
    'guide': {'id': 'Panduan', 'en': 'Guide', 'ja': 'ガイド', 'ms': 'Panduan'},
    'bot_tiers_badge': {
      'id': 'Catur Klasik Dunia Barat',
      'en': 'Classic Western Chess',
      'ja': 'クラシック・ウェスタンチェス',
      'ms': 'Catur Klasik Dunia Barat',
    },
    'shogi_features_badge': {
      'id': 'Catur Tradisional Jepang',
      'en': 'Traditional Japanese Chess',
      'ja': '本格派・伝統日本将棋',
      'ms': 'Catur Tradisional Jepun',
    },
    'profile': {
      'id': 'Profil',
      'en': 'Profile',
    ...
    'vs_player': {
      'id': 'Pass & Play (1 HP)',
      'en': 'Pass & Play (1 Device)',
      'ja': 'パス＆プレイ (1台で対戦)',
      'ms': 'Pass & Play (1 Telefon)',
    },
    'vs_player_sub': {
      'id': 'Lokal Berdua',
      'en': 'Local 2 Players',
    ...
    'vs_online': {
      'id': 'Mabar Online (2 HP)',
      'en': 'Online Match (2 Devices)',
      'ja': 'オンライン対戦',
      'ms': 'Mabar Online (2 Telefon)',
    },
    'vs_online_sub': {
      'id': 'Real-time via Kode',
      'en': 'Real-time via Room Code',
      'ja': '合言葉でマッチング',
      'ms': 'Masa Nyata guna Kod',
    },
    'create_room': {
      'id': 'Buat Room Baru',
      'en': 'Create Room',
    ...
    'enter_room_code': {
      'id': 'Masukkan Kode Room (misal: DC-1234):',
      'en': 'Enter Room Code (e.g. DC-1234):',
      'ja': '部屋コードを入力 (例: DC-1234):',
      'ms': 'Masukkan Kod Bilik (cth: DC-1234):',
    },
    'waiting_opponent': {
      'id': 'Menunggu lawan bergabung...',
      'en': 'Waiting for opponent to join...',
      'ja': '対戦相手の参加を待っています...',
      'ms': 'Menunggu lawan menyertai...',
    },
    'share_room_code': {
      'id': 'Bagikan kode ini ke teman Anda:',
      'en': 'Share this code with your friend:',
      'ja': 'このコードを友達に共有してください:',
      'ms': 'Kongsi kod ini kepada rakan anda:',
    },
    'choose_side_chess': {
